(function (jtd, undefined) {
    ...
    function initNavBar() {
      return fetch("https://shafayat1004.github.io/My-Notes/nav.html").then(function (response) {
    ...
    function initSearch() {
      ...
      request.open("GET", "https://shafayat1004.github.io/My-Notes/assets/js/search-data.json", true);
    ...
    jtd.setTheme = function (theme) {
      ...
      cssFile.setAttribute(
        "href",
        'https://shafayat1004.github.io/My-Notes/assets/css/just-the-docs-' + theme + ".css"
      );
    };
